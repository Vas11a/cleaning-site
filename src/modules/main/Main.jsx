        ...
        <div className='back pb-20'>
            <div className="main pt-0 sm:pt-4 mt-32 ">
                ...
                <div className="flex flex-col justify-end gap-5 items-end pt-10">
                    ...
                    <div className=' text-xl sm:text-lg relative z-10 w-full sm:w-1/2 lg:w-1/4 text-center lg:text-end'>Subtitle Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, animi!</div>
