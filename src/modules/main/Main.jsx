    ...
    return (
        <div className='back pb-20 '>
            <div className="main pt-0 sm:pt-4 mt-32 ">
                <div  className="title text-center sm:text-right text-4xl sm:text-5xl lg:text-7xl sm:pt-20 relative z-10">Ad clavum - файний  <br />
                    <div className="sm:pt-5">українскій текст</div>
                </div>
                <div className="flex flex-col justify-end gap-5 items-end pt-10">
                    <Number/>
                    <div className=' text-xl sm:text-lg relative z-10 w-full sm:w-1/2 lg:w-1/4 text-center lg:text-end xl:text-2xl'>Рандомний набір слів, перекладених на українську мову</div>
