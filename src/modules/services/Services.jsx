...
export default function Services() {
    ...
    const serviceList = [{
        ...
        information: [
            ...
            "Генеральне прибирання існує у 2-х тарифах: VIP Standart;",
        ...
        information: [
            ...
            "Домогосподарочка існує у 2-х тарифах: VIP Standart. дізнатися який варіант підходить саме Вам, можливо зателефонувавши нашому менеджеру чистоти;",
        ...
        information: [
            ...
            "Разове підтримуюче прибирання існує у 2-х варіантах: VIP Standart;"
            ['дізнатися який підходить саме Вам, можливо зателефонувавши нашому менеджеру чистоти'],
